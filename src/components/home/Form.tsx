...
const Form = () => {
  return (
    <div className="bg-background-paper py-20 px-6 lg:py-32 overflow-hidden">
      <div className="max-w-[1000px] mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4 mb-4">
          <input
            type="text"
            placeholder="First"
            className="w-full p-4 bg-background-paper border border-primary focus:border-primary transition-all placeholder:text-gray-900"
          />
          <input
            type="text"
            placeholder="Last"
            className="w-full p-4 bg-background-paper border border-primary focus:border-primary outline-none transition-all placeholder:text-gray-900"
          />
          <input
            type="email"
            placeholder="Email"
        ...
        <div className="flex items-start gap-5 text-left mb-16 max-w-[850px]">
          <div className="relative mt-1">
            <input 
              type="checkbox" 
              className="w-6 h-6 appearance-none bg-background-paper border-2 border-primary checked:bg-primary cursor-pointer transition-all relative after:content-[''] after:absolute after:hidden checked:after:block after:left-[7px] after:top-[2px] after:w-[6px] after:h-[12px] after:border-white after:border-b-2 after:border-r-2 after:rotate-45" 
            />
          </div>
          <p className="text-[8px] lg:text-sm leading-relaxed text-gray-800 font-medium opacity-90">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
          ...
          <button className="flex items-center group transition-transform active:scale-95">
            <div className=" relative left-[70px] md:h-14 md:w-20 flex items-center justify-center">
              <img 
            ...
            <div className="bg-primary h-16 md:h-14 pl-24 rounded-l-full flex items-center pr-8 text-white">
